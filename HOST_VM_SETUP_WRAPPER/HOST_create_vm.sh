...
if [ -z "$2" ]; then echo "The first argument to this script is the full path to your .ipsw file. The second argument to this script is the name for the VM you would like to create."
  ...
  prlctl set ${VM_NAME} --memsize $(bc <<< "($(sysctl -n hw.memsize)-6442450944)/1024/1024")
