...
sudo -u sftnight HOME=/Users/sftnight python3 -m pip install --force-reinstall --user --no-cache-dir -r "${SHARED_BARMAN_DIR}/VM_SETUP/ROOT/requirements.txt" openstacksdk==1.4.0 onnx==1.15.0 xgboost==2.0.3 urllib3==1.26.20
